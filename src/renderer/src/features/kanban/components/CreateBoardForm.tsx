...
export function CreateBoardForm({ onSubmit, onCancel }: CreateBoardFormProps): React.JSX.Element {
  ...
  return (
    <div className="bg-[var(--c-bg-1)] p-6 rounded-lg max-w-md w-full">
      <h2 className="text-xl font-semibold text-[var(--c-text-1)] mb-4">Create New Board</h2>
